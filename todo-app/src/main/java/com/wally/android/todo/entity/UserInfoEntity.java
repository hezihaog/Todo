...
public class UserInfoEntity extends BaseDaoEntity {
    ...
    @Generated(hash = 1038610114)
    public UserInfoEntity(Long rowId, String userId, String accountName,
            String nickName, String md5Pwd, Long createDate, int isLogicDelete) {
        this.rowId = rowId;
        this.userId = userId;
